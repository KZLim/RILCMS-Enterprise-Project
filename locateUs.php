...
<html>
    <head>
        ...
        <meta charset = "utf-8">
        <link rel="stylesheet" href="locateUs.css">
    ...
    <body>
        ...
        <div>
            ...
            <h1 class="image-caption"><b>Locate Us</b></h1>
            <h2  class="image-caption" style="top: 270px; left:200px">Hi ,Do you have any question or problem ?<br/>
                Come and Visit Us on one of the branche below ~  </h2>
            <a class="image-caption glowButton" href="#location" style="top: 370px;">Visit Us</a>
        </div>

        <div class="flex-container" id="location">
            <div class="flex-item-left">
                <img src="images/branch1.jpg" height="250px" width="400xp" style="margin-top:10px">
            ...
            <div class="flex-item-right">
                <img src="images/branch2.jfif" height="250px" width="400xp" style="margin-top:10px">
                <h1 style="font-size:25px; margin-top: 10px;">
        ...
        <div class="flex-container">
            <div class="flex-item-left">
                <img src="images/branch3.jpg" height="250px" width="400xp" style="margin-top:10px">
                <h1 style="font-size:25px; margin-top: 10px;">
            ...
            <div class="flex-item-right">
                <img src="images/branch4.jpg" height="250px" width="400xp" style="margin-top:10px">
                <h1 style="font-size:25px; margin-top: 10px;">
                    Kedah Branch:<br/>
                    1A,Lorong 1,<br/>
                    Taman Harmoni,<br/>
